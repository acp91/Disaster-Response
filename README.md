...
* precision, defined as <img src="https://latex.codecogs.com/gif.latex?\frac{True Positive}{True Positive + False Positive}" />, is good for measuring your model's performance when the cost of False Positive is high. False positive in our case would be message classified as "Accident" when in fact it isn't
...
* [Latex Symbols in Github](https://stackoverflow.com/questions/35498525/latex-rendering-in-readme-md-on-github)